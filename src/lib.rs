// src/lib.rs
/*
 * Core library for RevealedSecret
 */
...
#[derive(Debug)]
pub struct RevealedSecretProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RevealedSecretProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RevealedSecret processing");
    
    let mut processor = RevealedSecretProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RevealedSecretProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RevealedSecretProcessor::new(false);
